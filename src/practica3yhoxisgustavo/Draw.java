...
public class Draw extends ReceiverAdapter implements ActionListener, ChannelListener {
	...
	public void go() throws Exception {
		...
		/*** DEFINIMOS LAS CARACTER�STICAS DE LOS BOTONES ***/
		...
		/*** DEFINIMOS LAS CARACTER�STICAS DEL JFRAME PRINCIPAL ***/
		...
		/*** INSTANCIA DEL SUB_PANEL Y A�ADIDO DE BOTONES ***/
	...
	/*** M�TODO PARA MOSTRAR INGRESOS AL GRUPO ***/
	...
	protected class DrawPanel extends JPanel implements MouseMotionListener {
		...
		protected Image img; // para dibujar pixeles
